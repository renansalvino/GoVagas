...
export default function VisualizarVaga2({ navigation = useNavigation() }) {
  return (
    <ScrollView>
      ...
      <Menu navigation={navigation} />
        ...
        <View style={styles.main_Visualizar_Vaga1}>
          ...
          <View style={styles.Box_Vaga2}>
            <Image
              style={styles.Img_empresa}
              source={require('../../assets/images/ibm_logo.png')}
            />
          ...
          <View style={styles.row_numbers}>
            ...
            <Text style={styles.text_numbers} onPress={() => navigation.navigate("VisualizaVaga3")}>3</Text>
