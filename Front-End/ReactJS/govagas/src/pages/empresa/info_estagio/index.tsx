            ...
            <div className="info-estagio">
                <div className="info_estagio_2">
                    ...
                    <div className="publi-options_estagio2">
                        ...
                        <div className="estagio-options_estagio" >
                            <img src={Imgalerta} id="joinha" />
                        ...
                        <div className="avaliacao-1">
                            ...
                            <div id="align-date-avaliacao">
                                <Input type="date" id="date-avaliacao" name="date-avaliacao-forlabel" label="Date" />
                            </div>
                        </div>
                    </div>
                </div>
